...
let REACT_APP_BACKEND_URL = 'http://110.44.126.145/SamyakApp/API/Labadmin/'
...
if (window.location.hostname === 'localhost') {
	apiBaseUrl = `http://192.168.10.143/SamyakApp/API/Labadmin/`
	oAuthBaseUrl = 'http://192.168.10.143/SamyakApp/API/Labadmin/Ladadmin_Login'
